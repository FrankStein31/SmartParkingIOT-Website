        ...
        <div class="card p-5">
            <div class="card-header pb-0">
                ...
                <p class="text-sm">
                    ...
                    <span style="margin-left: 10px;">Distribusi parkir motor berdasarkan cara akses</span>
                </p>
            </div>
        ...
        <div class="card p-3">
            <div class="card-header pb-0">
                ...
                <p class="text-sm">
                    ...
                    <span style="margin-left: 10px;">Distribusi parkir motor berdasarkan jam dalam sehari</span>
                </p>
            </div>
            <div class="card-body p-3">
